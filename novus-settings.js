...
const NovusSettings = (() => {
  ...
  function _injectModal() {
    ...
    style.textContent = `
      ...
      .ns-danger-btn{width:100%;padding:10px;background:var(--red-bg);color:var(--red);border:1px solid rgba(239,68,68,.25);border-radius:8px;font-size:11px;font-weight:800;cursor:pointer;font-family:inherit}
